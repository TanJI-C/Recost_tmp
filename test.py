...
# tmp = fnode.parse_filter("((_p(10))::numeric = ((((number_column)::bpchar)::numeric + '2'::numeric) * '3'::numeric))")
# js = json.dumps(tmp.to_dict())
...
# 打印加载的JSON数据
RecostInit()
root = ParsePostgresPlanJson(data)
Recost(root)
# 将字典转换为 JSON 字符串
json_str = json.dumps(root.to_dict())
